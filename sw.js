const CACHE="homebase-v03-meatball-icon";
const ASSETS=["./","./index.html","./css/app.css","./js/app.js","./assets/meatball.jpeg","./manifest.webmanifest","./apple-touch-icon.png","./icon-192.png","./icon-512.png"];
