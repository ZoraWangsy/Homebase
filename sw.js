const CACHE="homebase-v04-daily-dedup";
const ASSETS=["./","./index.html","./css/app.css","./js/app.js?v=04","./assets/meatball.jpeg","./manifest.webmanifest","./apple-touch-icon.png","./icon-192.png","./icon-512.png"];
